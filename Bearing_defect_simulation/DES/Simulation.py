...
class Simulation(object):
    ...
    def run_ball_throught_defect(self,i:int,ball:RollingElement):
        ...
        # While ball still in defect (I know when it will leave the region)
    ...
    def get_amplitude(self,ball:RollingElement,interval_underball:tuple):
        #Calculate the amplitude of the vibration generated by the current
        # Defect
        ...
        if interval_underball[0]-1>=0:
            ...
            return amplitude
        # the first interval is a bit specific
        else:
            amplitude=self.m_gamma*(pos_current_contact_interval)
            return amplitude
    ...
    def find_interval_under_ball(self,ball:RollingElement,j):
        # Function that check all interval to see which one is under the 
        # ball and if it is high enough to enter in contact with the ball
    ...
    def start(self):
        # Let's start the threads and measure 
    ...
    def get_results(self,format:str,file_name='results.png',
        ...
        # displays the results of the simulation in the requested format
